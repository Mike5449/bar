...
export class EmployeeUpdateComponent implements OnInit {
  ...
  protected updateForm(employee: IEmployee): void {
    ...
    this.jobsSharedCollection = this.jobService.addJobToCollectionIfMissing<IJob>(this.jobsSharedCollection, employee.job);
  }
  ...
  protected loadRelationshipsOptions(): void {
    this.jobService
      ...
      .pipe(map((jobs: IJob[]) => this.jobService.addJobToCollectionIfMissing<IJob>(jobs, this.employee?.job)))
