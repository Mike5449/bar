...
describe('Shift Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'shift', component: ShiftComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.shifts?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to shiftService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getShiftIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getShiftIdentifier).toHaveBeenCalledWith(entity);
