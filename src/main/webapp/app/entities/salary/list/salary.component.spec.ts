...
describe('Salary Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'salary', component: SalaryComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to salaryService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getSalaryIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getSalaryIdentifier).toHaveBeenCalledWith(entity);
