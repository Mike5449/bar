package com.mycompany.mikedev.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.mycompany.mikedev.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.mycompany.mikedev.repository.UserRepository.USERS_BY_EMAIL_CACHE);
