...
public interface LeaveRequestRepository extends JpaRepository<LeaveRequest, Long> {
    ...
    @Query(
        value = "select distinct leaveRequest from LeaveRequest leaveRequest left join fetch leaveRequest.employee",
    ...
    @Query("select distinct leaveRequest from LeaveRequest leaveRequest left join fetch leaveRequest.employee")
