...
class PosteResourceIT {
    ...
    private static final String DEFAULT_POSTE_NAME = "AAAAAAAAAA";
    private static final String UPDATED_POSTE_NAME = "BBBBBBBBBB";
    ...
    public static Poste createEntity(EntityManager em) {
        Poste poste = new Poste().posteName(DEFAULT_POSTE_NAME);
        return poste;
    }
    ...
    public static Poste createUpdatedEntity(EntityManager em) {
        Poste poste = new Poste().posteName(UPDATED_POSTE_NAME);
        return poste;
    }
    ...
    void createPoste() throws Exception {
        ...
        assertThat(testPoste.getPosteName()).isEqualTo(DEFAULT_POSTE_NAME);
    }
    ...
    void getAllPostes() throws Exception {
        ...
        restPosteMockMvc
            ...
            .andExpect(jsonPath("$.[*].posteName").value(hasItem(DEFAULT_POSTE_NAME)));
    }
    ...
    void getPoste() throws Exception {
        ...
        restPosteMockMvc
            ...
            .andExpect(jsonPath("$.posteName").value(DEFAULT_POSTE_NAME));
    }
    ...
    void putExistingPoste() throws Exception {
        ...
        updatedPoste.posteName(UPDATED_POSTE_NAME);
        ...
        Poste testPoste = posteList.get(posteList.size() - 1);
        assertThat(testPoste.getPosteName()).isEqualTo(UPDATED_POSTE_NAME);
    }
    ...
    void partialUpdatePosteWithPatch() throws Exception {
        ...
        partialUpdatedPoste.posteName(UPDATED_POSTE_NAME);
