...
import com.mycompany.mikedev.repository.JobRepository;
import com.mycompany.mikedev.service.dto.JobDTO;
import com.mycompany.mikedev.service.mapper.JobMapper;
...
class JobResourceIT {
    ...
    public static Job createEntity(EntityManager em) {
        Job job = new Job().jobName(DEFAULT_JOB_NAME);
        return job;
    }
    ...
    public static Job createUpdatedEntity(EntityManager em) {
        Job job = new Job().jobName(UPDATED_JOB_NAME);
        return job;
    }
    ...
    void putExistingJob() throws Exception {
        ...
        updatedJob.jobName(UPDATED_JOB_NAME);
    ...
    void fullUpdateJobWithPatch() throws Exception {
        ...
        partialUpdatedJob.jobName(UPDATED_JOB_NAME);
